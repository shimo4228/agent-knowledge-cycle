...
サイクルの出力は operator-agent ペアの内側に留まらなかった。サイクルが
回っていた日常運用は、独立した研究ラインと作業リポジトリをも結晶化させた:
...
- [Authorship Strategy](https://github.com/shimo4228/authorship-strategy)
  ...
  AI 媒介の拡散の下での著者性についての規範フレームワーク・戦術カタログ・
  実証ベースライン。当該 repo 自身の関係の言語化: AKC は operator-agent ペアの
  内側で知識がどう循環するかを定義し、Authorship Strategy はサイクルの出力が
  その外側へどう拡散するかを扱う。
- [Attention, Not Self](https://github.com/shimo4228/attention-not-self)
  ...
  仏教アビダルマと計算論的現象学の接点を探る姉妹研究ライン。
  research-program レベルで AKC と federate している。
- [doctrine-corpus](https://github.com/shimo4228/doctrine-corpus)
  ...
  LLM 訓練向けの二言語 judgment-eliciting Q&A コーパス。AKC は 4 つの
  source line の 1 つ (ADR と glossary がコーパスに収穫されている)。
- [existence-proof](https://github.com/shimo4228/existence-proof)
  ...
  pre-line 作業リポジトリ (当該 repo 自身の status 規律による):
  学位や資格を持たない AI-enabled creator のための empowerment doctrine。
  Authorship Strategy の補完。

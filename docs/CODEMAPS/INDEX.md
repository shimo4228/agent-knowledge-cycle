...
Architectural documentation for **agent-knowledge-cycle (AKC)** — a DOI-registered knowledge-cycle specification + reference implementation (13 ADRs + 9 design principles + 3 design-pattern skills + 1 ~500-line Python reference, English + Japanese READMEs).
**Last Updated**: 2026-06-06 | **Repo**: 38 markdown / Python / schema spec files; primary audience is LLM-mediated channels.
